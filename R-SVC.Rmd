...
plot_decision_curve(modelt,curve.name=c('Support Vector Machine'),xlim=c(0,0.8),ylim=c(0,0.4),
...
```{r}
library(tidyverse)
tiff(filename="zhifangtu-SVC.tif", width=800*6, height=400*6, res=90*6)
...
tiff(filename="volin plot-SVC.tif", width=600*6, height=500*6, res=90*6)
par(mfrow = c(1,1), pty='s', mar=c(4,3,4,1),cex=1, font =1, col=1)
